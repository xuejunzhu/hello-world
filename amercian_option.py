# -*- coding: utf-8 -*-
"""
Created on Sat Nov 14 21:49:02 2020
https://github.com/lballabio/QuantLib-SWIG/blob/master/Python/examples/american-option.py
...
Traceback (most recent call last):
  ...
  File "<ipython-input-39-bb859c033b52>", line 1, in <module>
    option.setPricingEngine(ql.BaroneAdesiWhaleyApproximationEngine(process))

AttributeError: module 'QuantLib' has no attribute 'BaroneAdesiWhaleyApproximationEngine'
